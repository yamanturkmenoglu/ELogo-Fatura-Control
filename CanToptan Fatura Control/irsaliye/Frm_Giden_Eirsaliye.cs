...
{
    public partial class Frm_Giden_Eirsaliye : Form
    {
        public Frm_Giden_Eirsaliye()
        {
            InitializeComponent();
        ...
        private void Frm_Giden_Eirsaliye_Load(object sender, EventArgs e)
        {
            FillType();
            ...
            foreach (var document in documents)
            {
                ...
                if (docInfoElement != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(issueDateStr))
                    {
                        ...
                        {
                            row["Oluşturma Tarihi"] = issueDate.ToString("dd.MM.yyyy");
                        }
                        else
                        {
